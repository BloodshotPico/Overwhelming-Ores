...
public class EnrichedNetherQuartzOre extends BlockBase
{

	public EnrichedNetherQuartzOre(String name, Material material) 
	{
		super(name, material);
	...
	{
		return ModItems.ENRICHED_NETHER_QUARTZ;
	}
